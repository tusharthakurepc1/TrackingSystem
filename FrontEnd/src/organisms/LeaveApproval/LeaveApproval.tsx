...
import {ApplicationStructure} from './type'
import './style.scss'
                    ...
                    <Cell style={{ padding: '6px' }}>
                        
                        {
                            rowData => (
                                rowData.status === 3 ?
                                    <ButtonGroup>
                                        <Button onClick={()=>{acceptedLeaveReq(rowData._id)}} appearance='ghost' active style={{padding: '3px 5px'}}>Accept</Button>
                                        <Button onClick={()=>{rejectedLeaveReq(rowData._id)}} appearance='ghost' active style={{padding: '3px 5px'}}>Reject</Button>
                                    </ButtonGroup>
                                :
                                <>
                                    {
